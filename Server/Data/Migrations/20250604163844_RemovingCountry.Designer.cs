...
namespace Server.Data.Migrations
{
    ...
    [Migration("20250604163844_RemovingCountry")]
    partial class RemovingCountry
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Server.Entities.AboutUs", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.ToTable("User", t =>
                        {
                            t.Property("CreatedAt")
                                .HasColumnName("Provider_CreatedAt");
            ...
            modelBuilder.Entity("Server.Entities.Message", b =>
                {
                    b.HasOne("Server.Entities.Message", "ParentMessage")
                        .WithMany("Replies")
                        .HasForeignKey("ParentMessageId");

                    b.HasOne("Server.Entities.User", "Recipient")
                        .WithMany()
