...
namespace Server.Services
{
    public interface INotificationService
    {
        ...
        Task CreateNewFeedbackNotification(int adminId, int feedbackId);
        Task CreateNewFeedbackNotificationForAdmin(int adminId, int feedbackId);
Task CreateNewFeedbackNotificationForProvider(int providerId, int feedbackId);
}
}